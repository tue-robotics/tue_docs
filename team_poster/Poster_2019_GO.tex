...
%% PDF
\setstatustext{\includegraphics[height=14mm]{Figures/logoAtHome.pdf}\hspace{1.0cm}\includegraphics[height=14mm]{Figures/GO_2019}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\slidetitle[RoboCup~Montr\'{e}al~2018]{\vspace{10mm} Tech United Eindhoven}
...
\begin{bclogo}[couleur = white, arrondi = 0.25, couleurBord = tuedarkblue , barre = none, logo=\emptylogo]{\textcolor{tuedarkblue}{Unified application architecture}}
\begin{itemize}[itemsep = 0pt, parsep = 0pt, leftmargin=15pt]
