...
%% PDF
\setstatustext{\includegraphics[height=14mm]{Figures/logoAtHome.pdf}\hspace{1.0cm}\includegraphics[height=14mm]{Figures/logo_nagoya_2017_2}}
...
\begin{minipage}[T]{0.16\linewidth}
    \begin{center}
        \includegraphics[width=3cm]{Figures/Sponsors/Prodrive.pdf}
    \end{center}
\end{minipage}
...
\begin{minipage}[T]{0.155\linewidth}
    \begin{center}
        \includegraphics[width=3cm]{Figures/Sponsors/KPN2.pdf}
    \end{center}
\end{minipage}
\\
\vspace{0.2cm}
...
\begin{minipage}[T]{0.11\linewidth}
    \begin{center}
        \includegraphics[width=1.85cm]{Figures/Sponsors/SKM.pdf}
    \end{center}
\end{minipage}
\begin{minipage}[T]{0.11\linewidth}
    \begin{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\slidetitle[RoboCup~Nagoya~2017]{\vspace{10mm} Tech United Eindhoven}
...
\begin{minipage}[T]{0.35\linewidth}
    \begin{center}
    	\includegraphics[height=4cm]{Figures/HSR}
        \figcaption{HERO}
    \end{center}
\end{minipage}
%\hfill
...
\begin{minipage}[T]{0.29\linewidth}
    \begin{center}
    	\includegraphics[height=4cm]{Figures/SERGIO_small}
        \figcaption{SERGIO}
    \end{center}
\end{minipage}
