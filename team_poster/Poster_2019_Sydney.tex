...
%% PDF
\setstatustext{\includegraphics[height=15mm]{Figures/logoAtHome.pdf}\hspace{1.5cm}\includegraphics[height=15mm]{Figures/logo_sydney_2019}}
...
\begin{minipage}[T]{0.16\linewidth}
    \begin{center}
        \includegraphics[width=3cm]{Figures/Sponsors/KPN.pdf}
    \end{center}
\end{minipage}
%\hfill
\\
...
\begin{minipage}[T]{0.165\linewidth}
    \begin{center}
        \includegraphics[width=1.85cm]{Figures/Sponsors/EMR.pdf}
    \end{center}
\end{minipage}
\begin{minipage}[T]{0.155\linewidth}
    \begin{center}
        \includegraphics[width=1.85cm]{Figures/Sponsors/Reboocon_bionics_png.pdf}
    \end{center}
\end{minipage}
\\
\vspace{0.2cm}
...
\begin{minipage}[T]{0.115\linewidth}
    \begin{center}
        \includegraphics[width=1.85cm]{Figures/Sponsors/ProDrive.pdf}
    \end{center}
\end{minipage}
\\
\vspace{0.2cm}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\slidetitle[RoboCup~Sydney~2019]{\vspace{10mm} Tech United Eindhoven}
...
\begin{minipage}[T]{0.48\linewidth}
	\begin{center}
		\includegraphics[height=4cm]{Figures/HERO_travel}
		\figcaption{HERO}
	\end{center}
\end{minipage}
\hfill
...
%\vspace{0.2cm}
\vspace{-0.4cm} % remove when compiling on linux
...
\begin{minipage}[T]{0.48\linewidth}
	\begin{center}
		\includegraphics[height=2.7cm]{Figures/people_recognition1}
		%\figcaption{}
	\end{center}
\end{minipage}
\hfill
\begin{minipage}[T]{0.48\linewidth}
    \begin{center}
        \includegraphics[height=2.7cm]{Figures/people_recognition2}
        %\figcaption{}
    \end{center}
\end{minipage}
\begin{itemize}[topsep=0pt, itemsep = 0pt, parsep = 0pt, leftmargin=15pt]
...
%\vspace{0.2cm}
\vspace{-0.6cm} % remove when compiling on linux
...
%%\vspace{0.2cm}
%\vspace{-0.5cm} % remove when compiling on linux
%
...
%%	\begin{itemize}
%%		\item verb(object=robot, subject=world model entity)
%%	\end{itemize}
%\end{itemize}
%\end{bclogo}
