...
%% PDF
\setstatustext{\includegraphics[height=14mm]{Figures/logoAtHome.pdf}\hspace{1.5cm}\includegraphics[height=14mm]{Figures/GO_2017}}
...
\vspace{0.3cm}
\vspace{-1cm} % remove when compiling on linux

\begin{bclogo}[couleur = white, arrondi = 0.25, couleurBord = tuedarkblue, epBarre = 0, logo=\emptylogo]{\textcolor{tuedarkblue}{Improved manipulation}}
\medskip %\bigskip
...
\begin{bclogo}[couleur = white, arrondi = 0.25, couleurBord = tuedarkblue, epBarre = 0, logo=\emptylogo]{\textcolor{tuedarkblue}{Image recognition}}
\medskip %\bigskip
...
\vspace{0.2cm}
\vspace{-1.cm} % remove when compiling on linux
...
\vspace{0.2cm}
\vspace{-1.1cm} % remove when compiling on linux
