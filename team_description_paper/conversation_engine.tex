...
When the user supplies more information, the additional input is parsed in the context of what info is missing.% and the current action description is extended and retried.
%To parse the additional information to fill in gaps of missing info, the conversation\_engine must know what field of missing information (e.g. `source-location' of a `grab' action) must be parsed according to what rules.
